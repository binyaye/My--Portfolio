      ...
      <MDBCard style={{ width: "650px", background: "white", margin:"10px", height:'auto'}}>
        ...
        <MDBRow className='start' style={{paddingLeft:'10px'}}>
            <MDBCol md="0" style={{paddingRight:'10px'}}>
              <a href="https://github.com/binyaye"><img alt="Github" style={{height:'40px', width:'40px'}} src={ Github } /></a>
            </MDBCol>
            <MDBCol md="0" style={{paddingRight:'10px'}}>
              <a href="https://www.linkedin.com/in/binyam-tadele-3b125775/"><img alt="Linkedin" style={{height:'40px', width:'40px'}} src={ Linkedin } /></a>
            </MDBCol>
            <MDBCol md="0" style={{paddingRight:'10px'}}>
            <a href="https://stackoverflow.com/users/7774144/t-binyam"><img alt="Stack" style={{height:'40px', width:'40px'}} src={ Stack } /></a>
            </MDBCol>
            <MDBCol md="0" style={{paddingRight:'10px'}}>
              <a href="https://www.upwork.com/freelancers/~019edf4131004f9864?viewMode=1"><img alt="Upwork" style={{height:'40px', width:'40px'}} src={ Upwork } /></a>
            </MDBCol>
          </MDBRow>
        </MDBCardBody>
      </MDBCard>
